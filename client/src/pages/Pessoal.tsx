...
export default function Pessoal() {
  ...
  const addSubscription = trpc.subscriptions.create.useMutation({ onSuccess: () => { utils.subscriptions.list.invalidate({ clientId }); setDialogOpen(false); setName(""); setAmount(""); setBillingDay(""); } });
